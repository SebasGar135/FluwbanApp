...
export default function MetroScreen() {
  ...
  useEffect(() => {
    fetch('https://mock.apidog.com/m2/988210-973885-default/18777894')
      .then(res => res.json())
      .then(data => {
        setMetro(data);
        setLoading(false);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.transportName}>Metro</Text>
        <Text style={styles.transportDesc}>El Metro de Quito conecta el sur y norte de la ciudad de Quito de manera rápida y eficiente.</Text>
        ...
        <View style={styles.tarifasRow}>
          <Text style={styles.tarifasValue}>$0,45</Text>
          <Text style={styles.tarifasValue}>$0,22</Text>
          <Text style={styles.tarifasValue}>$0,22</Text>
      ...
      <View style={styles.listSection}>
        <Text style={styles.listTitle}>{metro.length} tipo</Text>
        {loading ? (
